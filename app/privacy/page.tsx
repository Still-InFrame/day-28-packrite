...
const sections: LegalSection[] = [
  {
    ...
    body: (
      <p>
        ...
        (&ldquo;we,&rdquo; &ldquo;us&rdquo;), the operator of packrite, collects,
        uses, and shares information when you use the Service. We aim to collect
        only what we need to run packrite.
      </p>
    ),
  },
  {
  ...
  {
    id: "ai-processing",
    title: "AI processing of your photos",
    body: (
      <p>
        To catalog an item, we send the photo to our AI provider,{" "}
        <span className="font-medium">Anthropic (Claude)</span>, which returns a
        description and attributes and performs a content-safety check. Photos are
        sent over the network for processing and are not used by us to train AI
        models. Anthropic&apos;s handling of API data is governed by its own terms
        and policies.
      </p>
    ),
  },
  {
    ...
    body: (
      <>
        ...
        />
        <p>These providers process data on our behalf to deliver the Service.</p>
      </>
    ),
  },
  {
  ...
  },
  {
    ...
    body: (
      <p>
        ...
        right to access, correct, export, or delete your personal information, and
