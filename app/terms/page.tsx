...
const sections: LegalSection[] = [
  {
    ...
    body: (
      <p>
        ...
        packrite (the &ldquo;Service&rdquo;), operated by Still In Frame
        Creatives, LLC (&ldquo;we,&rdquo; &ldquo;us,&rdquo; or &ldquo;our&rdquo;).
  ...
  },
  {
    ...
    body: (
      <p>
        ...
        &ldquo;as is&rdquo; — you are responsible for reviewing and correcting it.
      </p>
    ),
  },
  {
  ...
  {
    id: "moderation",
    title: "6. Content moderation, strikes & suspension",
    body: (
      <p>
        We use automated systems to review uploaded images. Content that violates
        Section 5 may be removed automatically. Each violation may result in a
        &ldquo;strike&rdquo; on your account; accumulating three (3) strikes
        results in your account being blocked. We may also suspend or terminate
        any account at our discretion for violations of these Terms or applicable
  ...
  },
  {
    ...
    body: (
      <p>
        You retain ownership of the photos and content you upload. You grant us a
        ...
        Service to you (including sending images to our AI provider for cataloging
        and generating signed links you choose to share).
      </p>
    ),
  },
  {
    id: "byo-key",
    title: "8. Bring-your-own API key",
    body: (
      <p>
        You may optionally provide your own Anthropic API key. If you do, AI
        requests are billed to your Anthropic account, and you are responsible for
        those charges and for complying with Anthropic&apos;s terms. Your key is
        encrypted and used only to process your cataloging requests.
      </p>
    ),
  },
  {
    id: "billing",
    title: "9. Free tier, subscriptions & billing",
    body: (
      <Bullets
        items={[
  ...
  {
    id: "sharing",
    title: "10. Shared links",
    body: (
      <p>
        If you enable sharing for a catalog, anyone with the unguessable link can
        view that catalog&apos;s items (read-only) without signing in. You can
        disable sharing or rotate the link at any time. Do not share links to
        catalogs containing content you wish to keep private.
      </p>
    ),
  },
  {
    ...
    body: (
      <p>
        ...
        Deleting your account removes your catalogs, items, and stored photos. We
        may suspend or terminate access as described in Section 6.
      </p>
    ),
  },
  {
    ...
    body: (
      <p>
        ...
        We do not warrant that AI-generated output is accurate, or that the
  ...
  },
  {
    ...
    body: (
      <p>
        ...
        lost profits or data. Our total liability for any claim relating to the
        Service will not exceed the greater of the amounts you paid us in the 12
  ...
  },
  {
    ...
    body: (
      <p>
        ...
        reflected by updating the &ldquo;Last updated&rdquo; date. Your continued
...
export default function TermsPage() {
  return (
    <LegalShell title="Terms of Use" updated="June 29, 2026" sections={sections} />
  );
}
